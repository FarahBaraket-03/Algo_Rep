...
public class Program3 {
    private static final AtomicReference<MatrixClock> matrixClock = 
        new AtomicReference<>(new MatrixClock("P3", 4));
    ...
    private static void executeLocalInstructions() {
        try {
            ...
            sendMessageWithConfirmation("m2_to_P4", PEER_ADDRESSES[2]);
    ...
    private static void addEventWithSleep(String eventName) throws InterruptedException {
        incrementClock();
        MessageTrackerClient.addEvent("P3", eventName, matrixClock.get().getClock());
        System.out.println("P3 event: " + eventName + " at clock: " + matrixClock.get());
        Thread.sleep(500);
    }
    ...
    private static void sendMessageWithConfirmation(String content, String address) throws InterruptedException {
        ...
        MessageTrackerClient.addEvent("P3", "send " + content, sendClock);
        System.out.println("P3 sending to " + address + ": " + content + " at clock: " + matrixClock.get());
    ...
    private static void handleClient(Socket socket) {
        try (ObjectInputStream in = new ObjectInputStream(socket.getInputStream())) {
            ...
            System.out.println("P3 received message: " + msg.getContent() + 
            ...
            MessageTrackerClient.addEvent("P3", eventDesc, matrixClock.get().getClock());
            MessageTrackerClient.addMessage(msg.getFromProcess(), "P3", msg.getContent(), 
                                         msg.getClock().getClock(), matrixClock.get().getClock());
            
            System.out.println("P3 processed receive at clock: " + matrixClock.get());
