...
public class Program2 {
    private static final AtomicReference<MatrixClock> matrixClock = 
        new AtomicReference<>(new MatrixClock("P2", 4));
    ...
    private static void executeLocalInstructions() {
        try {
            ...
            sendMessageWithConfirmation("m1_to_P3", PEER_ADDRESSES[1]);
    ...
    private static void addEventWithSleep(String eventName) throws InterruptedException {
        incrementClock();
        MessageTrackerClient.addEvent("P2", eventName, matrixClock.get().getClock());
        System.out.println("P2 event: " + eventName + " at clock: " + matrixClock.get());
        Thread.sleep(500);
    }
    ...
    private static void sendMessageWithConfirmation(String content, String address) throws InterruptedException {
        ...
        System.out.println("P2 sending to " + address + ": " + content + " at clock: " + matrixClock.get());
    ...
    private static void handleClient(Socket socket) {
        try (ObjectInputStream in = new ObjectInputStream(socket.getInputStream())) {
           ...
           String eventDesc = "recv " + msg.getContent();
            MessageTrackerClient.addEvent("P2", eventDesc, matrixClock.get().getClock());
            MessageTrackerClient.addMessage(msg.getFromProcess(), "P2", msg.getContent(), 
                                         msg.getClock().getClock(), matrixClock.get().getClock());
            
            System.out.println("P2 processed receive at clock: " + matrixClock.get());
